...
img1 = utils.load_image("./bird.jpg", normalize=False, size=224)
img2 = utils.load_image("./shihtzu_mypuppy.jpg", normalize=False, size=224)
img3 = utils.load_image("./tiger.jpg", normalize=False, size=224)
...
with tf.Session(graph=eval_graph) as sess:
    ...
    for i in range(batch_size):
        ...
        utils.visualize(batch_img[i], target_conv_layer_value[i], target_conv_layer_grad_value[i], gb_grad_value[i], size=224)